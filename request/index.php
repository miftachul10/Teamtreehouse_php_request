        ...
        <div class="row">
            <div class="col-3">	
                ...
                <form class="border rounded p-4" method="post" action="index.php">
                    ...
                    <input type="submit" class="mt-2 btn btn-info" name="submit" value="daftar" name="action">
                </form>
            </div> 
            <div class="col-3">
                <h3>Data Tim</h3>
                <form class="border rounded p-4" method="get" action="index.php">
                    ...
                    <input type="submit" class="mt-2btn btn-info" name="submit" value="tambah" name="action">
                </form>              
            </div>
        </div>
    </div>
